...
function buildOutputValues(config, meterValue, dayStartValue, ledger, monthStartValue) {
    ...
    return {
        'consumption.meter_reading': round(meter, 4),
        'consumption.kwh_per_m3': round(kwhPerM3, 6),
        'today.consumption': heute.m3,
        'today.kwh': heute.kwh,
        'today.cost': heute.kosten,
        'today.payments': heute.abschlaege,
        'today.balance': heute.saldo,
        'yesterday.consumption': gestern.m3,
        'yesterday.kwh': gestern.kwh,
        'yesterday.cost': gestern.kosten,
        'yesterday.payments': gestern.abschlaege,
        'yesterday.balance': gestern.saldo,
        'month.consumption': monat.m3,
        'month.kwh': monat.kwh,
        'month.cost': monat.kosten,
        'month.payments': monat.abschlaege,
        'month.balance': monat.saldo,
        'last_month.consumption': letzterMonat.m3,
        'last_month.kwh': letzterMonat.kwh,
        'last_month.cost': letzterMonat.kosten,
        'last_month.payments': letzterMonat.abschlaege,
        'last_month.balance': letzterMonat.saldo,
        'billing_year.consumption': abrechnungsjahr.m3,
        'billing_year.kwh': abrechnungsjahr.kwh,
        'billing_year.cost': abrechnungsjahr.kosten,
        'billing_year.payments': abrechnungsjahr.abschlaege,
        'billing_year.balance': abrechnungsjahr.saldo,
        'last_billing_year.consumption': letztesAbrechnungsjahr.m3,
        'last_billing_year.kwh': letztesAbrechnungsjahr.kwh,
        'last_billing_year.cost': letztesAbrechnungsjahr.kosten,
